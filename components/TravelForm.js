...
export default function TravelForm({mobileNumber,vehicleData,customerDetails}) {
  ...
  // console.log("CustomerDetails",customerDetails);
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        // console.log("Customer KYC Status",customerDetails['KYC Status']);
        // if (!customerDetails) {
        //   setShowAlert(true);
        //   return;
            ...
            <>
              ...
              <View style={styles.pickerContainer}>
                <Picker
                  ...
                  style={styles.picker}
                >
                  <Picker.Item label={t('selectbrand')} value='' color='#888888' />
                  <Picker.Item label={t('bridgestone')} value='Bridgestone' color='#888888' />
                  <Picker.Item label={t('goodyear')} value='Goodyear' color='#888888' />
                  <Picker.Item label={t('continental')} value='Continental' color='#888888' />
                </Picker>
              </View>
              ...
              <View style={styles.pickerContainer}>
                  <Picker
                    ...
                    style={styles.picker}
                  >
                    <Picker.Item label={t("trucknum")} value="" />
    ...
    {/* <View style={styles.FormContainer}>
      {!showAdditionalDetails && (
        ...
        {/* <CustomAlert
          ...
          message2="Customer KYC is incomplete. Please contact the Administration."
